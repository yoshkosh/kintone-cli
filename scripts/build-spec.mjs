...
// NOTE: Provenance for THIRD_PARTY_NOTICES.md / Apache-2.0 attribution.
// Stamped into the emitted JSON so a downstream consumer can identify the
// upstream source even after the YAML is dropped from the published tarball.
const UPSTREAM_ORIGIN = "https://github.com/kintone/rest-api-spec";
